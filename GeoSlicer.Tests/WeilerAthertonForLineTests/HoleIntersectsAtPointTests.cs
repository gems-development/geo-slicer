...
public class HoleIntersectsAtPointTests
{
    ...
    public void Diagonal_IntersectsAtZero()
    {
        Polygon polygon = new Polygon(
            ...
            new[]
            {
                new LinearRing(new Coordinate[]
                {
                    new(-3, -2), new(-2, -2), new(-2, -1), new(-3, -2)
                }),
                new LinearRing(new Coordinate[]
                {
                    new(0, 0), new(0, -1), new(1, 0), new(0, 0)
                }),
                new LinearRing(new Coordinate[]
                {
                    new(2, 2), new(2, 1), new(3, 2), new(2, 2)
                })
            });
        ...
        Polygon expectedA = new Polygon(
            new LinearRing(new Coordinate[]
            {
                new(4, 4), new(4, -4), new(-4, -4), new(0, 0), new(-1, 0), new(1, 0), new(0, 0), new(2, 2), new(2, 1), new(3, 2), new(2, 2), new(4, 4)
            }));
        Polygon expectedB = new Polygon(
            new LinearRing(new Coordinate[]
            {
                new(-4, 4), new(4, 4), new(-2, -2), new(-2, -1), new(-3, -2), new(-2, -2), new(-4, -4), new(-4, 4)
            }));
