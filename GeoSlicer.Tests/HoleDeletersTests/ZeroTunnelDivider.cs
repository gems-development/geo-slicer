...
public class ZeroTunnelDivider
{
    ...
    public void DivideZeroTunnels(LinearRing ring, out LinearRing resultRing,
        out LinkedList<Coordinate> problemCoordinates)
    {
        ...
        Coordinate[] coordinates, LinkedList<int> numberOfEqualCoordinates)
    {
        ...
        {
            if (intersection is >= LinesIntersectionType.Overlay and <= LinesIntersectionType.Equals or
                LinesIntersectionType.Inner or LinesIntersectionType.TyShaped)
            {
                return true;
            }
