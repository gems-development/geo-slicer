...
public class AreaAreaIntersector
{
        ...
        Coordinate areaLine2Point1, Coordinate areaLine2Point2)
    {
        ...
        {
            return AreaAreaIntersectionType.Outside;
        }

        return AreaAreaIntersectionType.Inside;
    }
}